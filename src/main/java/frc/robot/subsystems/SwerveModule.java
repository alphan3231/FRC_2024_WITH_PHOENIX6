...
public class SwerveModule {
    ...
    SimpleMotorFeedforward feedforward = new SimpleMotorFeedforward(Constants.DrivebaseConstants.driveKS,
    ...
    private void setSpeed(SwerveModuleState desiredState, boolean isOpenLoop) {
        if (isOpenLoop) {
            ...
            double velocity = Conversions.MPSToFalcon(desiredState.speedMetersPerSecond,
                    Constants.DrivebaseConstants.WHEEL_CIRCUMFERENCE, Constants.DrivebaseConstants.DRIVE_GEAR_RATIO);
    ...
    private void setAngle(SwerveModuleState desiredState) {
        Rotation2d angle = (Math
                .abs(desiredState.speedMetersPerSecond) <= (Constants.DrivebaseConstants.MAX_SPEED * 0.01)) ? lastAngle
    ...
    private Rotation2d getAngle() {
        return Rotation2d.fromDegrees(Conversions.falconToDegrees(mAngleMotor.getRotorPosition().getValueAsDouble(),
                Constants.DrivebaseConstants.ANGLE_GEAR_RATIO));
    }
    ...
    public SwerveModuleState getState() {
        return new SwerveModuleState(
                Conversions.falconToMPS(mDriveMotor.getRotorVelocity().getValueAsDouble(),
                        Constants.DrivebaseConstants.WHEEL_CIRCUMFERENCE,
                        Constants.DrivebaseConstants.DRIVE_GEAR_RATIO),
                getAngle());
    }
